...
public class PractitionerController {
  ...
  public Practitioner.Bundle
      searchByIdentifier( // will need to parse this since it is [system]|[code]  -> Need to send
                          // code along and verify response matches system type
