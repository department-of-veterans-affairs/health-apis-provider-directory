...
import gov.va.api.health.providerdirectory.service.PpmsProviderSpecialtiesResponse.Value;
...
public class PractitionerRoleTransformer implements PractitionerRoleController.Transformer {
  ...
  private Reference practitionerReference(ProviderResponse.Value provider) {
    return Reference.builder().reference("Practitioner/" + provider.providerIdentifier()).build();
  }
