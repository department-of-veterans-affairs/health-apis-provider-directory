    ...
    public void searchByFamilyAndGiven() {
        ...
        response =
                JacksonConfig.createMapper()
                        .readValue(
                                getClass().getResourceAsStream("/ppmsPractitionerRole/ppms-provider-by-identifier-response.json"),
                                ProviderResponse.class);
        contacts =
                JacksonConfig.createMapper()
                        .readValue(
                                getClass().getResourceAsStream("/ppmsPractitionerRole/ppms-provider-contact-response.json"),
                                ProviderContacts.class);
        specialties =
                JacksonConfig.createMapper()
                        .readValue(
                                getClass().getResourceAsStream("/ppmsPractitionerRole/ppms-provider-specialties-response.json"),
